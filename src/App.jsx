...
import { Plus, X, Phone, MapPin, ChevronLeft, ChevronRight, Heart, Car, Home, Briefcase, Wrench, ShoppingBag, LayoutGrid, LogOut, UserRound, SlidersHorizontal } from "lucide-react";
          ...
          <div style={s.authRow}>
            {currentUser ? (
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <button style={s.myAdsBtn} onClick={() => setShowMyAds(true)}>
                  Мои объявления
                </button>
...
const s = {
  ...
  searchRow: { position: "relative", maxWidth: 640, margin: "0 auto", padding: "0 16px 10px" },
  ...
  filterPanel: { maxWidth: 640, margin: "0 auto 14px", padding: "12px 16px 14px", background: "rgba(0,0,0,0.15)", borderRadius: 12, display: "flex", flexDirection: "column", gap: 10 },
